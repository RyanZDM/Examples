========================================================================
    ACTIVE TEMPLATE LIBRARY : XRSDaemon Project Overview
========================================================================

AppWizard has created this XRSDaemon project for you to use as the starting point for
...
XRSDaemon.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (XRSDaemon.h)
        GUID definitions                                (XRSDaemon_i.c)
        A type library                                  (XRSDaemon.tlb)
        Marshaling code                                 (XRSDaemon_p.c and dlldata.c)

XRSDaemon.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in XRSDaemon.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named XRSDaemon.pch and a precompiled types file named StdAfx.obj.
...
XRSDaemonps.vcxproj
	...
	dlldata.c, XRSDaemon_i.c and XRSDaemon_p.c which are required
	to build the proxy/stub DLL.

XRSDaemonps.vcxproj.filters
